            ...
            <div className={styles.wrapper}>
              <div className={styles.featuredBikeNewHeaderConta}>
                <div className={styles.wrapper1}>
                  ...
                  <div className={styles.heading4}>€69,07 NET/MONTH</div>
                </div>
              </div>
                ...
                <div className={styles.wrapper2}>
                  <div className={styles.buttonMargin}>
                    <div className={styles.button}>
                      <div className={styles.spanColorSwatchWrapper} />
                    </div>
                  </div>
                  <div className={styles.buttonMargin1}>
                    <div className={styles.button1}>
                      <div className={styles.spanColorSwatchWrapper1} />
                    </div>
                  </div>
                  <div className={styles.buttonMargin2}>
                    <div className={styles.button2}>
                      <div className={styles.spanColorSwatchWrapper2} />
                    </div>
                  </div>
                  <div className={styles.buttonMargin3}>
                    <div className={styles.button3}>
                      <div className={styles.spanColorSwatchWrapper3}>
            ...
            <div className={styles.wrapper3}>
              <div className={styles.featuredBikeNewHeaderConta1}>
                <div className={styles.wrapper4}>
                  ...
                  <div className={styles.heading41}>€69,07 NET/MONTH</div>
                </div>
              </div>
              <div className={styles.imageContainer1}>
                <div className={styles.bikeWrapper1}>
                ...
                <div className={styles.leftWrapper1}>
                ...
                <div className={styles.wrapper5}>
                  <div className={styles.buttonMargin4}>
                    <div className={styles.button4}>
                      <div className={styles.spanColorSwatchWrapper4} />
                    </div>
                  </div>
                  <div className={styles.buttonMargin5}>
                    <div className={styles.button5}>
                      <div className={styles.spanColorSwatchWrapper5} />
                    </div>
                  </div>
                  <div className={styles.buttonMargin6}>
                    <div className={styles.button6}>
                      <div className={styles.spanColorSwatchWrapper6} />
                    </div>
                  </div>
                  <div className={styles.buttonMargin7}>
                    <div className={styles.button7}>
                      <div className={styles.spanColorSwatchWrapper7}>
